...
namespace MewPipe.Accounts.OpenID.Extensions
{
    /// <summary>
    ...
    public class OpenIDSimpleRegistrationExtension : IOpenIDProtocolExtension
    {
        ...
        /// </summary>
        public Task<bool> OnValidateMessageAsync(Message message)
        {
        ...
        /// </summary>
        public Task<object> OnExtractResultsAsync(ClaimsIdentity identity, string claimedId, Message message)
        {
