...
namespace MewPipe.Website.Oauth
{
    public static class OauthErrors
    {
        ...
        public static OauthError InvalidParameter = new OauthError ("invalid_request", "Invalid parameter(s), see details", 401 );
        public static OauthError ParameterRequired = new OauthError ("invalid_request", "A/Some required parameter(s) is missing, see details", 400);
