...
namespace MewPipe.Logic.MongoDB
{
    ...
    ///         <providers>
    ///             <add name="MongoSessionStateProvider" type="MewPipe.Logic.MongoDB.MongoSessionStateStore"
    ///                 connectionStringName="MewPipeMongoConnection"
    ///                 cookieName="COOKIE_NAME_HERE"
    ...
    public sealed class MongoSessionStateStore : SessionStateStoreProviderBase
    {
        ...
        public MongoSessionStateStore(string connectionString, string applicationName)
        {
